...
const ConfessionPage = () => {
    ...
    return (
        <div className="confession-container w-6/12 mx-auto flex flex-col items-center bg-gray-100 p-8 rounded-lg shadow-md">
            <h1 className="text-4xl font-bold text-center mb-6 text-yellow-500">Spill the Tea</h1>
            ...
            {confessions.length > 0 && (
                <section className="confessions mt-8">
                    <h2 className="text-2xl font-medium text-center text-yellow-500">Confessions Heard</h2>
